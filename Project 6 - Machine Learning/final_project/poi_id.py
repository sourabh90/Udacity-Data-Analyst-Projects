...
data_dict = remove_bad_records(data_dict, ["TOTAL", "LOCKHART EUGENE E"])
...
from utils.pipeline_models import pipeline_RF_model
...
grid_search = pipeline_KNN_model(features_train, labels_train, features_test, labels_test)
