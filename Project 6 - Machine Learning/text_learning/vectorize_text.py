...
for name, from_person in [("sara", from_sara), ("chris", from_chris)]:
    for path in from_person:
        ...
        if temp_counter == 0:
            ...
            email_text = email_text.replace("sara", "").replace("chris", "")
            email_text = email_text.replace("shackleton", "")
            email_text = email_text.replace("germani", "")

            # Removing most powerful word - sshacklensf
            email_text = email_text.replace("sshacklensf", "")
            #email_text = email_text.replace("houectect", "")
...
print "Word number 34597 : ", feature_names[34596]
